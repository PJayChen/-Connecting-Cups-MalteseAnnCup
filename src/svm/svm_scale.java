	...
	private void run(String []argv) throws IOException
	{
		...
		{			
			...
			switch(argv[i-1].charAt(1))
			{
				...
				case 'o': scaled_filename = argv[i];	break;
				default:
		...
		if (scaled_filename != null) {			
			try {
				fp_scaled = new BufferedWriter(new FileWriter(scaled_filename));
			} catch(IOException e) {
				System.err.println("can't open file " + scaled_filename);
				System.exit(1);
			}
		}
		...
		fp.close();
		if (fp_scaled != null) fp_scaled.close();
	}
